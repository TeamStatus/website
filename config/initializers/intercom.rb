IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = ENV["INTERCOM_APP_ID"] || "a98tsrtw"

  # == Intercom secret key
  # This is required to enable secure mode, you can find it on your Intercom
  # "security" configuration page.
  #
  config.api_secret = "o4-XQYOCN651Lo_SQSdg2fRbzttKmRM1Duf6Ng0d"
  ...
  #
  config.api_key = "fa5c49ec984b67f78bddd99545467a54c1f6479b"
  ...
  config.user.custom_data = {
    ...
    :number_of_boards => Proc.new { |current_user| current_user.boards.count }
  }
